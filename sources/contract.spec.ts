...
//         let trxResult = await sendTransfer(itemNFT, notOwner.getSender(), toNano("0.1"), notOwner.address, emptyAddress, 0n, beginCell().asSlice());
//         expect(trxResult.transactions).toHaveTransaction({
...
//         let trxResult = await sendTransfer(itemNFT, owner.getSender(), toNano("0.1"), notOwner.address, owner.address, toNano("1"), beginCell().asSlice());
//         expect(trxResult.transactions).toHaveTransaction({
//             from: owner.address,
//             to: itemNFT.address,
//             success: false,
...
//         let trxResult = await sendTransfer(itemNFT, owner.getSender(), toNano("1"), notOwner.address, owner.address, toNano("1.1"), beginCell().asSlice());
//         expect(trxResult.transactions).toHaveTransaction({
//             from: owner.address,
//             to: itemNFT.address,
//             success: false,
...
//         let trxResult = await sendTransfer(itemNFT, owner.getSender(), fwd_fee, notOwner.address, owner.address, toNano("0.1") - minTonsForStorage, beginCell().storeStringTail("testing").asSlice());
...
//             let trxResult = await sendTransfer(itemNFT, owner.getSender(), toNano("0.1"), notOwner.address, owner.address, 0n, beginCell().asSlice());
//             expect(trxResult.transactions).toHaveTransaction({
//                 from: owner.address,
//                 to: itemNFT.address,
//                 success: false,
...
//             defaultContent = beginCell().storeRef(defaultCommonContent).endCell();
...
//         expect(staticData.collectionContent).toEqualCell(defaultCommonContent);
//     });
